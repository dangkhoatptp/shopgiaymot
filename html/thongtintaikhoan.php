                    ...
                    <div class="container__box show">
                        <form class="box__info" action="thongtintaikhoan.php" method="post">
                            ...
                            <div class="info__group-info">
                                ...
                                <button onclick="clickButtonSave(1);" class="group-info__button-save display-none" type="submit" name="saveUsername">Lưu</button> -->
                            </div>
                            <div class="info__group-info">
                        ...
                        <form class="box__avatar" action="../html/xulidoiavatar.php" method="POST" enctype="multipart/form-data">
